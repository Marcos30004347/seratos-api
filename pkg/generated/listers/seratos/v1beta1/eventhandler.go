...
type EventHandlerLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.EventHandler, err error)
...
// List lists all EventHandlers in the indexer.
func (s *eventHandlerLister) List(selector labels.Selector) (ret []*v1beta1.EventHandler, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.EventHandler))
	})
	return ret, err
}
...
type EventHandlerNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.EventHandler, error)
...
// List lists all EventHandlers in the indexer for a given namespace.
func (s eventHandlerNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.EventHandler, err error) {
...
// Get retrieves the EventHandler from the indexer for a given namespace and name.
func (s eventHandlerNamespaceLister) Get(name string) (*v1beta1.EventHandler, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("eventhandler"), name)
	}
	return obj.(*v1beta1.EventHandler), nil
}
