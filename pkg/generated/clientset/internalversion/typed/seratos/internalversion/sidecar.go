...
type SidecarInterface interface {
	Create(ctx context.Context, sidecar *seratos.Sidecar, opts v1.CreateOptions) (*seratos.Sidecar, error)
	Update(ctx context.Context, sidecar *seratos.Sidecar, opts v1.UpdateOptions) (*seratos.Sidecar, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*seratos.Sidecar, error)
	List(ctx context.Context, opts v1.ListOptions) (*seratos.SidecarList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *seratos.Sidecar, err error)
	SidecarExpansion
}
...
func newSidecars(c *SeratosClient, namespace string) *sidecars {
	return &sidecars{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sidecars) Get(ctx context.Context, name string, options v1.GetOptions) (result *seratos.Sidecar, err error) {
	result = &seratos.Sidecar{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sidecars").
		Name(name).
...
func (c *sidecars) List(ctx context.Context, opts v1.ListOptions) (result *seratos.SidecarList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &seratos.SidecarList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sidecars").
...
func (c *sidecars) Create(ctx context.Context, sidecar *seratos.Sidecar, opts v1.CreateOptions) (result *seratos.Sidecar, err error) {
	result = &seratos.Sidecar{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sidecars").
...
func (c *sidecars) Update(ctx context.Context, sidecar *seratos.Sidecar, opts v1.UpdateOptions) (result *seratos.Sidecar, err error) {
	result = &seratos.Sidecar{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sidecars").
...
func (c *sidecars) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *seratos.Sidecar, err error) {
	result = &seratos.Sidecar{}
