...
type FooInterface interface {
	Create(ctx context.Context, foo *seratos.Foo, opts v1.CreateOptions) (*seratos.Foo, error)
	Update(ctx context.Context, foo *seratos.Foo, opts v1.UpdateOptions) (*seratos.Foo, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*seratos.Foo, error)
	List(ctx context.Context, opts v1.ListOptions) (*seratos.FooList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *seratos.Foo, err error)
	FooExpansion
}
...
func newFoos(c *SeratosClient, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Get(ctx context.Context, name string, options v1.GetOptions) (result *seratos.Foo, err error) {
	result = &seratos.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(ctx context.Context, opts v1.ListOptions) (result *seratos.FooList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &seratos.FooList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Create(ctx context.Context, foo *seratos.Foo, opts v1.CreateOptions) (result *seratos.Foo, err error) {
	result = &seratos.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(ctx context.Context, foo *seratos.Foo, opts v1.UpdateOptions) (result *seratos.Foo, err error) {
	result = &seratos.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *seratos.Foo, err error) {
	result = &seratos.Foo{}
