...
import (
	"github.com/Marcos30004347/seratos-api/pkg/generated/clientset/internalversion/scheme"
...
func (c *SeratosClient) Sidecars(namespace string) SidecarInterface {
	return newSidecars(c, namespace)
}

// NewForConfig creates a new SeratosClient for the given config.
func NewForConfig(c *rest.Config) (*SeratosClient, error) {
	config := *c
	...
	return &SeratosClient{client}, nil
}

// NewForConfigOrDie creates a new SeratosClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *SeratosClient {
...
// New creates a new SeratosClient for the given RESTClient.
func New(c rest.Interface) *SeratosClient {
	return &SeratosClient{c}
}
...
func (c *SeratosClient) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
