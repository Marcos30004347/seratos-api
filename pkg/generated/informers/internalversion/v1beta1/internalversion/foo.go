...
import (
	...
	internalversion "github.com/Marcos30004347/seratos-api/pkg/generated/listers/v1beta1/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Seratos().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Seratos().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&v1beta1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&v1beta1.Foo{}, f.defaultInformer)
}
